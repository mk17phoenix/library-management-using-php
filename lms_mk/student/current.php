                    ...
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="current.php" method="post">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input style="border-radius:50px;" type="text" id="title" name="title" placeholder="Enter Book Name/Book Id." class="span8" required>
                                                <button style="border-radius:50px;" type="submit" name="submit"class="btn btn-danger">Search</button>
                                            </div>
                                        </div>
                                    </form>
                                    <br>
